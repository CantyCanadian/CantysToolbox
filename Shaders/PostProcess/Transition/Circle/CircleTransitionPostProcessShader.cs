...
[ExecuteInEditMode]
public class CircleTransitionPostProcessShader : MonoBehaviour
{
    ...
    private void OnRenderImage(RenderTexture src, RenderTexture dst)
    {
        ...
        ShaderMaterial.SetFloat("_Size", ReverseEffect ? TransitionValue * radius : (1.0f - TransitionValue) * radius);
