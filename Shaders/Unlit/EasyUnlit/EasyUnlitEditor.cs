...
[ExecuteInEditMode]
public class EasyUnlitMaterialEditor : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        ExposeMaterialProperties(materialEditor, properties);
    ...
    private void ExposeMaterialProperties(MaterialEditor editor, MaterialProperty[] properties)
    {
        ...
        editor.TextureProperty(properties[0], ShaderProperties.MAIN_TEXTURE_DESCRIPTION);
