...
public abstract class SerializableCallbackBase : ISerializationCallbackReceiver
{
	...
	public Object Target { get { return m_Target; } set { m_Target = value; ClearCache(); } }

	/// <summary> Target method name </summary>
	public string MethodName { get { return m_MethodName; } set { m_MethodName = value; ClearCache(); } }

	public object[] Arguments { get { return ArgumentsBuffer != null ? ArgumentsBuffer : ArgumentsBuffer = m_Arguments.Select(x => x.GetValue()).ToArray(); } }
	public object[] ArgumentsBuffer;

	public Type[] ArgumentTypes { get { return ArgumentTypesBuffer != null ? ArgumentTypesBuffer : ArgumentTypesBuffer = m_Arguments.Select(x => Argument.RealType(x.Type)).ToArray(); } }
	public Type[] ArgumentTypesBuffer;

	public bool Dynamic { get { return m_Dynamic; } set { m_Dynamic = value; ClearCache(); } }
