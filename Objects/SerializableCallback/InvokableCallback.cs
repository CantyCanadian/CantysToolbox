...
public class InvokableCallback<TReturn> : InvokableCallbackBase<TReturn>
{
	...
	public InvokableCallback(object target, string methodName)
    {
        ...
        {
			Function = (System.Func<TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<TReturn>), target, methodName);
		}
	}
}
...
public class InvokableCallback<T0, TReturn> : InvokableCallbackBase<TReturn>
{
	...
	public InvokableCallback(object target, string methodName)
    {
        ...
        {
			Function = (System.Func<T0, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, TReturn>), target, methodName);
		}
	}
}
...
public class InvokableCallback<T0, T1, TReturn> : InvokableCallbackBase<TReturn>
{
	...
	public InvokableCallback(object target, string methodName)
    {
        ...
        {
			Function = (System.Func<T0, T1, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, T1, TReturn>), target, methodName);
		}
	}
}
...
public class InvokableCallback<T0, T1, T2, TReturn> : InvokableCallbackBase<TReturn>
{
	...
	public InvokableCallback(object target, string methodName)
    {
        ...
        {
			Function = (System.Func<T0, T1, T2, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, T1, T2, TReturn>), target, methodName);
		}
	}
}
...
public class InvokableCallback<T0, T1, T2, T3, TReturn> : InvokableCallbackBase<TReturn>
{
	...
	public InvokableCallback(object target, string methodName)
    {
        ...
        {
			Function = (System.Func<T0, T1, T2, T3, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, T1, T2, T3, TReturn>), target, methodName);
		}
	}
}