...
namespace Canty
{
    public static class VectorExtention
    {
        ...
        {
            return new Vector3(target.x == 0.0f ? 0.0f : 1.0f, target.y == 0.0f ? 0.0f : 1.0f,
                target.z == 0.0f ? 0.0f : 1.0f);
        }
        ...
        {
            return new Vector4(target.x == 0.0f ? 0.0f : 1.0f, target.y == 0.0f ? 0.0f : 1.0f,
                target.z == 0.0f ? 0.0f : 1.0f, target.w == 0.0f ? 0.0f : 1.0f);
        }
