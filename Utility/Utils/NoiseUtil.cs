...
// Original code taken from https://github.com/keijiro/PerlinNoise
...
namespace Canty
{
    public static class NoiseUtil
    {
        ...
        public static float PerlinNoise(float x)
        {
            ...
            return Mathf.Lerp(Fade(floorX), Gradient(PermanentValues[floorLast8BitsX], floorX),
                       Gradient(PermanentValues[floorLast8BitsX + 1], floorX - 1)) * 2;
        }
        ...
        public static float PerlinNoise(float x, float y)
        {
            ...
            return Mathf.Lerp(fadeY,
                Mathf.Lerp(fadeX, Gradient(PermanentValues[last8Bits1], floorX, floorY),
                    Gradient(PermanentValues[last8Bits2], floorX - 1, floorY)),
                Mathf.Lerp(fadeX, Gradient(PermanentValues[last8Bits1 + 1], floorX, floorY - 1),
                    Gradient(PermanentValues[last8Bits2 + 1], floorX - 1, floorY - 1)));
        }
        ...
        public static float PerlinNoise(float x, float y, float z)
        {
            ...
            return Mathf.Lerp(fadeZ,
                Mathf.Lerp(fadeY,
                    Mathf.Lerp(fadeX, Gradient(PermanentValues[last8BitsAA], floorX, floorY, floorZ),
                        Gradient(PermanentValues[last8BitsBA], floorX - 1, floorY, floorZ)),
                    Mathf.Lerp(fadeX, Gradient(PermanentValues[last8BitsAB], floorX, floorY - 1, floorZ),
                        Gradient(PermanentValues[last8BitsBB], floorX - 1, floorY - 1, floorZ))),
                Mathf.Lerp(fadeY,
                    Mathf.Lerp(fadeX, Gradient(PermanentValues[last8BitsAA + 1], floorX, floorY, floorZ - 1),
                        Gradient(PermanentValues[last8BitsBA + 1], floorX - 1, floorY, floorZ - 1)),
                    Mathf.Lerp(fadeX, Gradient(PermanentValues[last8BitsAB + 1], floorX, floorY - 1, floorZ - 1),
                        Gradient(PermanentValues[last8BitsBB + 1], floorX - 1, floorY - 1, floorZ - 1))));
        }
